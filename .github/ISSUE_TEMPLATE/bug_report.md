...
### 🩺 诊断日志 (Diagnostic Report)
> 请将 `./install.sh` 菜单 `6) 生成 Bug Report` 在主目录下导出的 `nyxniri-bug-report-*.md` 文件内容粘贴在下方代码块中：

```text
<!-- 在此处粘贴 nyxniri-bug-report.md 的日志内容 -->
```

### 📷 截图 / 录屏 (Screenshots / Record)
若有视觉错乱或报错弹窗，请在此粘贴截图。

### ℹ️ 补充信息 (Additional Context)
任何其他有助于排查问题的背景信息。
